...
const BrandProvider = (type,params) => {
    switch (type) {
        case GET_LIST: {
            return service.post('brand/brands',params).then((response) => {
        ...
        case GET_ONE:{
            return service.post('brand/getBrand',params).then((response) => {
                const data = response.data
                console.log(data)
                data.id = data._id
                if(data.message){
        ...
        case CREATE: {
            return service.post('brand/addBrand',params.data).then((response) => {
                const data = response.data
                data.id = data._id
                if(data.message){
                    throw new Error(data.message)
        ...
        case GET_MANY:{
            return service.post('brand/getBrandByArray',params).then((response) => {
                const data = response.data
                if(data.message){
                    throw new Error(data.message)
                }
